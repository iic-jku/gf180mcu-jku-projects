...
entity synthesizer is
    port (
        ...
        amplitude_shift_i   : in amplitude_shift_array;
        phase_increment_i   : in phase_inc_array;
        phase_value_i       : in phase_val_array;
        phase_sync_strobe_i : in std_logic_vector(CHANNEL_COUNT-1 downto 0);
        phase_set_strobe_i  : in std_logic_vector(CHANNEL_COUNT-1 downto 0);
        waves_o             : out std_logic_vector(CHANNEL_COUNT-1 downto 0)
    );
end entity;
    ...
    gen_channels: for i in 0 to CHANNEL_COUNT-1 generate
        channel_inst: entity work.channel
            port map (
                clock_i             => clock_i,
                reset_i             => reset_i,
                amplitude_shift_i   => amplitude_shift_i(i),
