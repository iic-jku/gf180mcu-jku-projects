...
iverilog -g2005 -DSIM -I "$RTL" "$RTL/clk_enable.v" "$RTL/max7219_driver.v" "$RTL/spi_master.v" "$RTL/$name.v" "$SRC_FOLDER/${name}_tb.v" # -I"$RTL" for multiple Verilog file dependencies in "src" folder
